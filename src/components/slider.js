import React, { Component } from 'react';
 ...
 import slide_1 from '../img/stand.jpg';
 import slide_2 from '../img/suble.jpg';
 import slide_3 from '../img/table.jpg';
 import slide_4 from '../img/vyveska.jpg';
...
*/
	...
	dots(index, event) {
	 ...
	 renderSlides() {
		 const transition = 100/this.state.length + "%"
